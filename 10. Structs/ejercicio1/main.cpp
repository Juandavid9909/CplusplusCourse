...
club, pedir datos al usuario para un corredor y asignarle una categoria de competición:
- Juvenil <= 18 años
- Señor <= 40 años
- Veterano > 40 años
Posteriormente imprimir todos los datos del corredor, incluida la categoría de competición
*/
